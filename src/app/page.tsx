          ...
          >
            {[
              ...
              <motion.div 
                key={i} 
                variants={fadeInUp} 
                className="bg-gray-50 rounded-2xl p-4 md:p-5 flex items-center justify-between gap-2 hover:bg-gray-100 transition-colors border border-gray-100/50 transform-gpu will-change-transform isolate"
            ...
            <motion.div 
              variants={fadeInUp} 
              className="bg-red-50 border border-red-100 rounded-2xl p-4 md:p-5 flex items-center justify-between gap-2 hover:bg-red-100 transition-colors shadow-sm shadow-red-100/50 relative overflow-hidden transform-gpu will-change-transform isolate"
              style={{ WebkitTransform: 'translate3d(0,0,0)', WebkitBackfaceVisibility: 'hidden' }}
            >
