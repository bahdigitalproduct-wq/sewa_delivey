...
export default function Header() {
  ...
  // On masque le menu du haut sur l'espace d'administration
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-sm">
        <div className="container mx-auto px-4 md:px-6 h-16 md:h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3" onClick={() => setMobileMenuOpen(false)}>
            <Image src="/logo.png" alt="Sewa Delivery Logo" width={56} height={56} className="object-contain drop-shadow-sm" />
            <span className="text-xl md:text-2xl font-black text-gray-900 tracking-tight">Sewa Delivery</span>
          </Link>
